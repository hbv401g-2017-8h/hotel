...
public class SearchResultPanel extends JPanel
{
	...
	public SearchResultPanel()
	{
		...
		searchTableModel.setColumnIdentifiers(new String[] { "Hotel",
				"Number of single beds", "Number of double beds",
				"En Suite Bathroom", "Cost per night", "Book" });
		searchTable = new JTable();
		searchTable.setFont(new Font("Dialog", Font.PLAIN, 12));
		searchTable.setModel(searchTableModel);
		searchTable.getTableHeader().setReorderingAllowed(false);

		searchTable.getColumn("Book")
				.setCellRenderer(new ButtonTableRenderer());
		searchTable.getColumn("Book")
				.setCellEditor(new ButtonTableEditor(new JCheckBox(), this));
		...
		starLabel.setText("Stars: Min: " + starMin.toString() + " Max: "
				+ starMax.toString());
		...
		priceLabel.setText("Price: Min:" + priceMin.toString() + " Max: "
				+ priceMax.toString());
		...
		singleBedLabel.setText("Single Beds: Min: " + singleBedMin.toString()
				+ " Max: " + singleBedMax.toString());
		...
		doubleBedLabel.setText("Double Beds: Min:" + doubleBedMin.toString()
				+ " Max: " + doubleBedMax.toString());
		...
		doubleBedRangeSlider.addChangeListener(new ChangeListener()
		{
			public void stateChanged(ChangeEvent e)
			{
				...
				doubleBedLabel
						.setText("Double Beds: Min:" + doubleBedMin.toString()
								+ " Max: " + doubleBedMax.toString());
		...
		singleBedRangeSlider.addChangeListener(new ChangeListener()
		{
			public void stateChanged(ChangeEvent e)
			{
				...
				singleBedLabel
						.setText("Single Beds: Min: " + singleBedMin.toString()
								+ " Max: " + singleBedMax.toString());
		...
		priceRangeSlider.addChangeListener(new ChangeListener()
		{
			public void stateChanged(ChangeEvent e)
			{
				...
				priceLabel.setText("Price: Min:" + priceMin.toString()
	...
	private void applyOrderAndFilters()
	{
		...
		if (String.valueOf(comboBox.getSelectedItem())
				.equals("Stars: Low to high"))
			search.sort(SortBy.STARCOUNT_ASCENDING);
		if (String.valueOf(comboBox.getSelectedItem())
				.equals("Stars: High to low"))
	...
	private void showSearchResults()
	{
		...
		{
			searchTableModel.addRow(new Object[] { r.getHotel().getName(),
					r.getNumberOfSingleBeds(), r.getNumberOfDoubleBeds(),
					(r.getEnSuiteBathroom() ? "Yes" : "No"),
					r.getCostPerNight(), "Book" });
		}
	}
